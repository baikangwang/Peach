...
namespace Peach.Core
{
    ...
    public class HomeViewParser : ViewParser
    {
        ...
        {
            OnParserStatusChanged(new ParserStatusEventArgs("Starting to extract all of galleries..."));
            ...
            OnParserStatusChanged(new ParserStatusEventArgs("Finish to extract all of galleries..."));
        ...
        protected override Gallery GetGallery(string html, bool cleanup = false)
        {
            ...
            //if (match == null)
            //{
            //    Logger.Current.Warn(string.Format("Fail to parse gallery tag"));
            //    return null;
            //}
