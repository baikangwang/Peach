namespace Peah.YouHu.API.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        [Route("Accounts/UserInfo")]
        public virtual UserInfoViewModel GetUserInfo()
        {
        ...
        [AllowAnonymous]
        [Route("Accounts/ExternalLogins")]
        public virtual IEnumerable<ExternalLoginViewModel> GetExternalLogins(string returnUrl, bool generateState = false)
        {
        ...
        [Route("Accounts/AddExternalLogin")]
        ...
        [AllowAnonymous]
        [Route("Accounts/ExternalLogin", Name = "ExternalLogin")]
        ...
        [OverrideAuthentication]
        [HostAuthentication(DefaultAuthenticationTypes.ExternalBearer)]
        [Route("Accounts/RegisterExternal")]
